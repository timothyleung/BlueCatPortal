...
<form name="form1" method="post"
	...
	<input type="submit" value="search"> <a id="export" class="myButton" download="data.csv" href="#">export</a>
</form>
<table cellspacing="0" width="200%" border="1" borderColor='#DEE6EE' id='resulttable' name='resulttable' class='resulttable'>
	<hans:SeachShow />
</table>
<br />